...
final User ronald =
    User(id: 2, name: 'Ronald', imageUrl: 'assets/images/ronald.jpg');
final User mark = User(id: 3, name: 'Mark', imageUrl: 'assets/images/mark.jpg');
final User step =
    User(id: 4, name: 'Step', imageUrl: 'assets/images/step.jpg');
...
// FAVORITE CONTACTS
List<User> favorites = [ronald,step, mark, steven, greg];
